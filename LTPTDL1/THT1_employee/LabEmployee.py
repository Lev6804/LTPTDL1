...
# dsNhanVien = []
# fr = open('D:\Education\Code\Python\LTPTDL1\THT1_employee\dbemp_input.db',mode='r',encoding='utf-8')
# for line in fr:
...
while(True):
    ...
    # elif userChoice == 18:
        ...
        fw =open('D:\Education\Code\Python\LTPTDL1\THT1_employee\dbemp_output.db',mode='w',encoding ='utf-8')
        for item in dsNhanVien:
            fw.write(f'{item.code}-{item.name}-{item.age}-{item.salary}-{item.income()}\n')
        fw.close() 
